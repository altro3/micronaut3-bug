...
*/
    ...
    @Tool(
        description = """
    Выполнить финальный сбор данных, сохранение черновика и немедленный запуск рекламной кампании. 
    🔥 ВАЖНО: Вызывай этот инструмент СТРОГО на Шаге 3 алгоритма, когда пользователь ответил 'да' на финальный отчет. 
    Передай в параметры все собранные из истории диалога данные (название, города, возраст, ИНН, текст).
    """
    )
