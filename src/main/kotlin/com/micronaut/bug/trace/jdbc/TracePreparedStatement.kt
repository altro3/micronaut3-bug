...
class TracePreparedStatement(
    ...
    serverPort: Long,
    dbNamespace: String?
) : BaseTraceStatement(tracer, traceProps, serverAddress, serverPort, dbNamespace), PreparedStatement by delegate {
    ...
    override fun executeLargeUpdate(): Long =
        executeWithTrace(sql) { delegate.executeLargeUpdate() }
