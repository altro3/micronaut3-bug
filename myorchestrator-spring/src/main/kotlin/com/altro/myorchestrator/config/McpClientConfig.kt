...
class McpClientConfig {
    ...
    fun adbrokerMcpClient(
        ...
        val client = McpClient.async(transport.transport())
            ...
            .clientInfo(Implementation(mcpProps.name, mcpProps.name, mcpProps.version, null, null, null))
            .build()
    ...
    @Bean
    fun yandexMcpToolProvider(mcpAsyncClient: McpAsyncClient): AsyncMcpToolCallbackProvider =
        AsyncMcpToolCallbackProvider.builder()
            .mcpClients(listOf(mcpAsyncClient))
            .build()
}
