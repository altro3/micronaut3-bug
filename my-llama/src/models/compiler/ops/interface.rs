...
pub enum Op {
    ...
    RoPEAndAttention { input: TensorView, layer_idx: usize, output: TensorView, num_heads: i32, num_kv_heads: i32, head_dim: i32 },
    ...
    AdamWStep { weight_idx: usize, lr: f32, beta1: f32, beta2: f32, eps: f32, weight_decay: f32, step: f32 },
}
