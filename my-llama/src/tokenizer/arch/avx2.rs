...
pub unsafe fn split(text: &str, ids_buffer: &mut [u32], byte_fallback: &[u32; 256]) -> usize {
    ...
    while idx + 128 <= len {
        ...
        let m0 = !_mm256_movemask_epi8(delim0);
        let m1 = !_mm256_movemask_epi8(delim1);
        let m2 = !_mm256_movemask_epi8(delim2);
        let m3 = !_mm256_movemask_epi8(delim3);

        process_mask_generic!(m0, idx, 0, write_ptr, end_write_ptr, bytes_ptr, fallback_ptr, buffer_len, u32);
        process_mask_generic!(m1, idx, 32, write_ptr, end_write_ptr, bytes_ptr, fallback_ptr, buffer_len, u32);
        process_mask_generic!(m2, idx, 64, write_ptr, end_write_ptr, bytes_ptr, fallback_ptr, buffer_len, u32);
        process_mask_generic!(m3, idx, 96, write_ptr, end_write_ptr, bytes_ptr, fallback_ptr, buffer_len, u32);
