...
macro(download_llama_dependency DEP_NAME DEP_SOURCE DEP_TAG)
    ...
    if (NOT EXISTS "${LOCAL_DEP_DIR}/include" AND NOT EXISTS "${LOCAL_DEP_DIR}/CMakeLists.txt")
        ...
        FetchContent_Populate(${DEP_NAME}_download)
...
if (NOT TARGET my_llama_cutlass_headers)
    add_library(my_llama_cutlass_headers INTERFACE)
    target_include_directories(my_llama_cutlass_headers INTERFACE
